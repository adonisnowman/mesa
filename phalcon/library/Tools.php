...
class Tools
{
    ...
    public static function getToken($id = 'abcd123456789', $expires = '+1 day', $Subject = [] ,$passphrase = 'QcMpZ&b&mo3TPsPk668J6QH8JA$&U&m2')
    {
        $signer  = new Hmac();
        ...
        $builder
            ...
            ->setSubject(json_encode($Subject))   // sub
    ...
    public static function mime_content_type($filename , $ext = false) {
        ...
        if($ext) {
            return array_search( mime_content_type($filename) , $mime_types );
        }
