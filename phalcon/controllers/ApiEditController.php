...
class ApiEditController extends BaseController
{
    ...
    public function Input_checkKeys(){       
        $UniqueKeys = ["ControllerName","ActionName"];
        $TableName = "checkKeys";
        $PostData = _Api::Input_checkKeys(self::$PostData);
        return _Api::InuptTable($TableName,$PostData, self::$checkKeys[__FUNCTION__], $UniqueKeys,self::$Rule);        
    }

    public function Input_Accounts(){        
        $UniqueKeys = ["account","mobile"];
        $TableName = "Accounts";
        $PostData = _Api::Input_Accounts(self::$PostData);
        return _Api::InuptTable($TableName,$PostData, self::$checkKeys[__FUNCTION__], $UniqueKeys,self::$Rule);
    }

    public function Input_RedirectAdmin(){        
        $UniqueKeys = ["ViewsPath","ViewsType","FileName"];
        $TableName = "RedirectAdmin";
        
        $PostData = _Api::Input_RedirectAdmin(self::$PostData);
        return _Api::InuptTable($TableName,$PostData, self::$checkKeys[__FUNCTION__], $UniqueKeys,self::$Rule);
    }
    
    public function Input_checkKeysRule(){  
        $UniqueKeys = ["UniqueID_checkKeys"];
        $TableName = "checkKeysRule";        
        $PostData = _Api::Input_checkKeysRule(self::$PostData);
        return _Api::InuptTable($TableName,$PostData, self::$checkKeys[__FUNCTION__], $UniqueKeys,self::$Rule);
    }
