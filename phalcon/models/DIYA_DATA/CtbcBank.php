...
class CtbcBank extends BaseModel
{
	...
	public function beforeValidationOnCreate()
	{
        ...
        $this->Mark  = mb_convert_kana(  $this->Mark, 'as');  
        $this->created_time = date("Y-m-d",strtotime($this->created_time));
    ...
    public static function resetValues($Item)
    {
          ...
          $Item['Mark'] = mb_convert_kana( $Item['Mark'], 'as');  
